...
import flintcresttrade.musical.flintcrestaudiodepot.di.dataModule
import flintcresttrade.musical.flintcrestaudiodepot.di.dispatcherModule
import flintcresttrade.musical.flintcrestaudiodepot.di.viewModule
...
class WHDBNApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@WHDBNApplication)
            modules(appModules)
        }
